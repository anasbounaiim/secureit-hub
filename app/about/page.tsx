    ...
    <section className="max-w-6xl mx-auto space-y-10 md:space-y-12 lg:space-y-16">
      ...
      <header className="space-y-4">
        ...
        <p className="text-sm md:text-base text-gray-400 max-w-2xl leading-[1.7]">
          ...
          and reliable remote operations. Experience across Belgian production
          environments and remote infrastructure management, working daily with
          live network systems and security-sensitive connectivity.
        </p>
        ...
        <div className="space-y-6 md:space-y-7">
          ...
          <div className="relative rounded-2xl border border-emerald-500/35 bg-black/80 shadow-[0_0_30px_rgba(16,185,129,0.35)] overflow-hidden">
            ...
            <div className="relative p-4 sm:p-5 space-y-4 text-sm md:text-[15px] text-gray-200 leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <p>
                  Network Engineer operating hybrid infrastructures with focus on
                  VPN connectivity, firewall operations and reliable network paths.
                </p>

                <p>
                  Background built around clear troubleshooting, structured
                  analysis and service continuity.
                </p>

                <p>
                  Certified <span className="text-emerald-300">CCNP Security – SVPN</span>,
                  <span className="text-emerald-300"> CCNA</span> and
                  <span className="text-emerald-300"> Linux+</span>.
                </p>

                <p>
                  Ubuntu used as primary operating system, with Kali Linux in a
                  virtual environment for protocol testing and structured
                  security learning.
                </p>

                <p>
                  Clarity in communication and stable network design guide my
                  daily work.
                </p>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-black/75 overflow-hidden">
            ...
            <div className="p-4 space-y-3 text-[12px] md:text-[13px] text-gray-200 leading-relaxed">
              ...
              <p>
                Hands-on work with Cisco, Fortinet, Zscaler (ZIA / ZPA),
                VPN technologies, Infoblox and F5.
              </p>

              <p>
                These platforms are used to maintain connectivity, visibility,
                segmentation and secure access across distributed infrastructures.
              </p>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="relative rounded-2xl border border-white/10 bg-black/75 overflow-hidden">
              ...
              <div className="p-4 space-y-3 text-[12px] md:text-[13px] text-gray-200 leading-relaxed">
                ...
                <p>
                  I document what matters, simplify where it improves stability
                  and automate when it increases operational consistency.
                </p>
...
mode full remote
focus secure connectivity firewall operations vpn reliability service continuity
